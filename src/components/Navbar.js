...
const Navbar = () => {
  ...
  return (
    <nav className='relative w-full'>
      <div className='bg-white px-9 pt-10 pb-2 flex items-center  font-rubik '>
